...
//
	...
	$cid = $_GET['id'];
     $get_donor_information = mysql_query("SELECT * FROM donations WHERE id = '" . $cid . "'");
          $donor_information = mysql_fetch_assoc($get_donor_information);
                       
	$redirect = "contact-details.php?id=".$donor_information['donor_id'];

	redirect('Donation Updated',$redirect);
}
