...
<?php if ($totalRows_contactlist) { ?>
  ...
  <?php $row_count = 1; do {  ?>
        <tr <?php if ($row_count%2) { ?>bgcolor="#F4F4F4"<?php } ?>>
          <td style="padding-left:5px"><a href="contact-details.php?id=<?php echo $row_contactlist['user_id']; ?>"><?php echo $row_contactlist['alloc_short_name']; ?> <?php echo $row_contactlist['contact_last']; ?></a></td>
